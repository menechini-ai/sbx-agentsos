...
**Conhecimento**
O serviço X apresenta timeout quando recebe mais de 500 requisições simultâneas.
...
A regra será: uma skill deve existir no nível mais baixo possível que ainda permita sua reutilização.
...
Essa documentação será adotada como o "contrato arquitetural" do projeto.
